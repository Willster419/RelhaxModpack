...
namespace RelhaxModpack
{
    ...
    public static class Translations
    {
        ...
        public static void loadHashes()
        {
            ...
            german.Add("modsNotFoundTechnical", "Die folgenden Modifikationen können nicht gefunden werden und scheinen gelöscht zu sein. Es sind leider nur technische Namen verfügbar:\n{0}");
