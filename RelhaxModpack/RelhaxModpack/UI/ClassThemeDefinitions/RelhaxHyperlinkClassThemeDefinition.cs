...
{
    class RelhaxHyperlinkClassThemeDefinition : IClassThemeDefinition
    {/// <summary>
     /// The Type object that corresponds to this UI class
     /// </summary>
        public Type ClassType { get; } = typeof(RelhaxHyperlink);

        //background
        /// <summary>
        /// Determines if background color is allowed to change
        /// </summary>
        public bool BackgroundAllowed { get; } = false;
        ...
        /// </summary>
        public DependencyProperty BackgroundDependencyProperty { get; } = UserControl.BackgroundProperty;
        ...
        /// </summary>
        public DependencyProperty ForegroundDependencyProperty { get; } = UserControl.ForegroundProperty;
