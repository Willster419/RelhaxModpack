...
{
    /// <summary>
    /// Allows for creation of a macro from a parsed HTML web page (with JavaScsript), using the Substring method.
    /// </summary>
    public class MacroSubstringBrowserTask : MacroSubstringHtmlTask, IXmlSerializable, IHtmlParseTask
    {
        ...
        /// </summary>
        public new const string TaskCommandName = "macro_substring_browser";
