...
MD E:\Relhax\Working_on_MOD
copy %~dp0RELHAX_E.lnk %public%\desktop
copy %~dp0FileZilla.lnk E:\Relhax
copy %~dp0ModpackPatchCheck.lnk E:\Relhax
copy %~dp0ModpackTest.lnk E:\Relhax
copy %~dp0MODXML.lnk E:\Relhax
copy %~dp0RelhaxModpack.exe E:\Relhax
copy %~dp0Remote.exe E:\Relhax
copy %~dp0Settings.lnk E:\Relhax
copy %~dp0Slack.lnk E:\Relhax
copy %~dp0XMLValidation.url E:\Relhax
